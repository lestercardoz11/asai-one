    ...
    <footer className="mt-auto bg-navy-900 text-navy-100">
      <div className="container-page grid grid-cols-2 gap-x-6 gap-y-10 py-16 md:grid-cols-12">
        ...
        <div className="col-span-2 md:col-span-4">
          ...
          <div className="mt-6 flex flex-col gap-2 text-sm text-navy-200">
            <a href="mailto:support@asai.one" className="inline-flex items-center gap-2 transition-colors hover:text-white">
        ...
        {COLUMNS.map((col) => (
          ...
          >
            <h3 className="type-mono text-navy-300">{col.title}</h3>
        ...
        <div className="col-span-2 md:col-span-2">
          <h3 className="type-mono text-navy-300">Follow</h3>
          <div className="mt-4 flex gap-2">
            {SOCIAL.map(({ label, href, Icon }) => (
              <a
                ...
                className="grid h-10 w-10 place-items-center border border-navy-700 text-navy-200 transition-colors hover:border-navy-300 hover:text-white"
              >
      ...
      <div className="border-t border-navy-700">
        <div className="container-page flex flex-col items-center justify-between gap-2 py-5 sm:flex-row">
          <p className="type-mono text-[10px] text-navy-300">
